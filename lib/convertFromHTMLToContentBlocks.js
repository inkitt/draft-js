...
var isValidCentered = function isValidCentered(node) {
  if (!node) {
    return false;
  }
...
var ContentBlocksBuilder = /*#__PURE__*/function () {
  ...
  _proto.__addCenteredNode = function __addCenteredNode(node, style) {
    var entityConfig = {};
    var text = node.innerText;
    this.currentEntity = this.entityMap.__create('centered', 'MUTABLE', entityConfig || {});
